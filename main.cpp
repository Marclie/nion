...
void boostQuaternionComparison(int trials) {
    ...
    for (int i = 0; i < trials; ++i) {
        ...
        // addition
        {
            ...
            diff = getMAEboost<long double>(nionResult, boostResult);
            MRE_Add += diff;
    ...
    std::cout << "Average norm error for nion: " << MRE_Norm / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Norm / trials
              << std::endl;
    std::cout << "\nMaximum norm error between nion and boost::math::quaternion: " << MAX_Norm << std::endl;
    std::cout << "nion: " << maxNormNion << "\nboost::math::quaternion: " << maxNormBoost << std::endl;
    std::cout << "input: " << max1value << std::endl;
    
    
    /*** Addition ***/
    std::cout << "\n\n ---> Addition <---" << std::endl;
    std::cout << "Average addition time for nion: " << addNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average addition error for nion: " << MRE_Add / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Add/ trials
              << std::endl;
    std::cout << "\nMaximum addition error between nion and boost::math::quaternion: " << MAX_Add << std::endl;
    std::cout << "nion: " << maxAddNion << "\nboost::math::quaternion: " << maxAddBoost << std::endl;
    ...
    std::cout << "Average conjugate time for nion: " << conjNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average conjugate error for nion: " << MRE_Conj / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Conj/ trials
              << std::endl;
    std::cout << "\nMaximum conjugate error between nion and boost::math::quaternion: " << MAX_Conj << std::endl;
    std::cout << "nion: " << maxConjNion << "\nboost::math::quaternion: " << maxConjBoost << std::endl;
    std::cout << "input: " << max1valueConj << std::endl;


    /*** Multiplication ***/
    std::cout << "\n\n ---> Multiplication <---" << std::endl;
    std::cout << "Average multiplication time for nion: " << mulNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average multiplication error for nion: " << MRE_Mul / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Mul/ trials
              << std::endl;
    std::cout << "\nMaximum multiplication error between nion and boost::math::quaternion: " << MAX_Mul << std::endl;
    std::cout << "nion: " << maxMulNion << "\nboost::math::quaternion: " << maxMulBoost << std::endl;
    ...
    /*** Division ***/
    std::cout << "\n\n ---> Division <---" << std::endl;
    std::cout << "Average division time for nion: " << divNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average division error for nion: " << MRE_Div / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Div/ trials
              << std::endl;
    std::cout << "\nMaximum division error between nion and boost::math::quaternion: " << MAX_Div << std::endl;
    std::cout << "nion: " << maxDivNion << "\nboost::math::quaternion: " << maxDivBoost << std::endl;
    ...
    /*** Exponential ***/
    std::cout << "\n\n ---> Exponential <---" << std::endl;
    std::cout << "Average exp time for nion: " << expNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average exp error for nion: " << MRE_Exp / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Exp/ trials
              << std::endl;
    std::cout << "\nMaximum exp error between nion and boost::math::quaternion: " << MAX_Exp << std::endl;
    std::cout << "nion: " << maxExpNion << "\nboost::math::quaternion: " << maxExpBoost << std::endl;
    std::cout << "input: " << max1valueExp << std::endl;


    /*** Power ***/
    std::cout << "\n\n ---> Power <---" << std::endl;
    std::cout << "Average pow time for nion: " << powNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average pow error for nion: " << MRE_Pow / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Pow/ trials
              << std::endl;
    std::cout << "\nMaximum pow error between nion and boost::math::quaternion: " << MAX_Pow << std::endl;
    std::cout << "nion: " << maxPowNion << "\nboost::math::quaternion: " << maxPowBoost << std::endl;
    std::cout << "input: " << max1valuePow << std::endl;


    /*** Sine ***/
    std::cout << "\n\n ---> Sine <---" << std::endl;
    std::cout << "Average sin time for nion: " << sinNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average sin error for nion: " << MRE_Sin / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Sin/ trials
              << std::endl;
    std::cout << "\nMaximum sin error between nion and boost::math::quaternion: " << MAX_Sin << std::endl;
    std::cout << "nion: " << maxSinNion << "\nboost::math::quaternion: " << maxSinBoost << std::endl;
    std::cout << "input: " << max1valueSin << std::endl;


    /*** Cosine ***/
    std::cout << "\n\n ---> Cosine <---" << std::endl;
    std::cout << "Average cos time for nion: " << cosNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average cos error for nion: " << MRE_Cos / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Cos/ trials
              << std::endl;
    std::cout << "\nMaximum cos error between nion and boost::math::quaternion: " << MAX_Cos << std::endl;
    std::cout << "nion: " << maxCosNion << "\nboost::math::quaternion: " << maxCosBoost << std::endl;
    std::cout << "input: " << max1valueCos << std::endl;


    /*** Tangent ***/
    std::cout << "\n\n ---> Tangent <---" << std::endl;
    std::cout << "Average tan time for nion: " << tanNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average tan error for nion: " << MRE_Tan / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Tan/ trials
              << std::endl;
    std::cout << "\nMaximum tan error between nion and boost::math::quaternion: " << MAX_Tan << std::endl;
    std::cout << "nion: " << maxTanNion << "\nboost::math::quaternion: " << maxTanBoost << std::endl;
    std::cout << "input: " << max1valueTan << std::endl;


    /*** Hyperbolic Sine ***/
    std::cout << "\n\n ---> Hyperbolic Sine <---" << std::endl;
    std::cout << "Average sinh time for nion: " << sinhNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average sinh error for nion: " << MRE_Sinh / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Sinh/ trials
              << std::endl;
    std::cout << "\nMaximum sinh error between nion and boost::math::quaternion: " << MAX_Sinh << std::endl;
    std::cout << "nion: " << maxSinhNion << "\nboost::math::quaternion: " << maxSinhBoost << std::endl;
    std::cout << "input: " << max1valueSinh << std::endl;


    /*** Hyperbolic Cosine ***/
    std::cout << "\n\n ---> Hyperbolic Cosine <---" << std::endl;
    std::cout << "Average cosh time for nion: " << coshNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average cosh error for nion: " << MRE_Cosh / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Cosh/ trials
              << std::endl;
    std::cout << "\nMaximum cosh error between nion and boost::math::quaternion: " << MAX_Cosh << std::endl;
    std::cout << "nion: " << maxCoshNion << "\nboost::math::quaternion: " << maxCoshBoost << std::endl;
    std::cout << "input: " << max1valueCosh << std::endl;


    /*** Hyperbolic Tangent ***/
    std::cout << "\n\n ---> Hyperbolic Tangent <---" << std::endl;
    std::cout << "Average tanh time for nion: " << tanhNionTimer / trials << " ns" << std::endl;
    ...
    if (speedup > 1)
        ...
        std::cout << "nion is " << 1 / speedup << " times SLOWER than boost::math::quaternion" << std::endl;
    std::cout << "Average tanh error for nion: " << MRE_Tanh / trials << std::endl;
    std::cout << "Average relative difference between nion and boost::math::quaternion: " << MAE_Tanh/ trials
              << std::endl;
    std::cout << "\nMaximum tanh error between nion and boost::math::quaternion: " << MAX_Tanh << std::endl;
    std::cout << "nion: " << maxTanhNion << "\nboost::math::quaternion: " << maxTanhBoost << std::endl;
    std::cout << "input: " << max1valueTanh << std::endl;
}
...
void boostOctonionComparison(int trials){
    ...
    for (int i = 0; i < trials; ++i) {
        ...
        nion<T> nion1(vals1, 8);
        nion<T> nion2(vals2, 8);
